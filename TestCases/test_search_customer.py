...
class Test_AddCustomer_004:
    ...
    def test_searchcustomer_004_TestCase(self,catch1):
        ...
        logs.info("*************test_searchcustomer_004_TestCase ********************")
        ...
        self.search.SetInput("victoria_victoria@nopCommerce.com")
        logs.info("************* Search my email options ********************")
